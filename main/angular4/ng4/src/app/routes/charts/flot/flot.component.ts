...
export class FlotComponent implements OnInit {
    ...
    constructor(private http: Http, pt: PagetitleService, private colors: ColorsService) {
        ...
        this.getChartData('assets/static/chart/bar.json').subscribe(data => this.barData = data);
        this.getChartData('assets/static/chart/barstacked.json').subscribe(data => this.barStackeData = data);
        this.getChartData('assets/static/chart/spline.json').subscribe(data => this.splineData = data);
        this.getChartData('assets/static/chart/area.json').subscribe(data => this.areaData = data);
        this.getChartData('assets/static/chart/line.json').subscribe(data => this.lineData = data);
