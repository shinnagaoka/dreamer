                  ...
                  <div class="px-5">
                    ...
                    <!-- div class="form-group mt-4">
                      <label class="custom-control custom-checkbox mb-0">
                        <input class="custom-control-input" type="checkbox"><span class="custom-control-indicator"></span><span class="custom-control-description" value="checked" name="auto_login">ログイン状態にする</span>
                      </label>
                    </div> -->
