                ...
                <ul>
                  ...
                  <li><a href="#"><span class="float-right nav-caret"><em class="ion-ios-arrow-right"></em></span><span class="float-right nav-label"></span><span class="nav-icon"><em class="ion-ios-list-outline"></em></span><span>カテゴリー別</span></a>
                    <ul class="sidebar-subnav" id="tables">
                      <li><a href="tables.classic.html"><span class="float-right nav-label"></span><span>職業</span></a></li>
                      <li><a href="tables.responsive.html"><span class="float-right nav-label"></span><span>人間関係</span></a></li>
                      <li><a href="datatable.html"><span class="float-right nav-label"></span><span>健康</span></a></li>
                      <li><a href="footable.html"><span class="float-right nav-label"></span><span>勉強</span></a></li>
                      <li><a href="bootgrid.html"><span class="float-right nav-label"></span><span>お金</span></a></li>
                      <li><a href="bootgrid.html"><span class="float-right nav-label"></span><span>その他</span></a></li>
                    </ul>
                  </li>
                            ...
                            <div class="cardbox-body">
                              <div class="clearfix mb-3">
                                ...
                                <div class="text-center">
                                  <h1 style="margin: 0">グローバルエンジニアになる</h1>
                                </div>
                              </div>
                     <div class="">
